...
type
  ...
  TFixedTimeAnalysisCommand = class(TAnalysisCommand) // "go movetime" command
  private
    FTimeMsec: int64;
  public
    function GetCommandString: string; override;
...
function TFixedTimeAnalysisCommand.GetCommandString: string;
begin
  Result := 'go movetime ' + IntToStr(FTimeMsec);
end;

constructor TFixedTimeAnalysisCommand.Create(TimeMsec: int64);
begin
  FTimeMsec := TimeMsec;
end;
